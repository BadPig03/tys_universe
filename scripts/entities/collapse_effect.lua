local Lib = TYU
local CollapseEffect = Lib:NewModEntity("Collapse Effect", "COLLAPSEEFFECT")
...
CollapseEffect:AddCallback(ModCallbacks.MC_POST_EFFECT_UPDATE, CollapseEffect.PostEffectUpdate, Lib.ModEntityIDs.COLLAPSEEFFECT.Variant)
